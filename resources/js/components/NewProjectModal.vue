    ...
    <modal name="new-project" classes="p-10 card rounded-lg" height="auto">
        ...
        <div class="flex">
            ...
            <div class="flex-1 mr-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="title"
                           class="border p-2 text-xs block w-full rounded mt-2"
                           :class="form.errors.title ? 'border-red' : 'border-grey-dark'"
                            v-model="form.title">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description"
                              class="border p-2 text-xs block w-full rounded mt-2"
                              :class="form.errors.description ? 'border-red' : 'border-grey-dark'"
            ...
            <div class="flex-1 ml-4">
                ...
                <div class="mb-4" >
                    <label for="title" class="text-sm">Need Some Tasks?</label>
                    <input type="text"
                           class="border border-grey-dark mb-2 mt-2 p-2 text-xs block w-full rounded"
                           placeholder="Task 1"
                ...
                <button type="button" class="inline-flex items-center">
                    ...
                    <span class="text-xs" @click="addTask">Add New Task Field</span>
